...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.roles.permissions.index', compact(['roles', 'permissionGroup']));
    }
    ...
    public function show($permission_group_id, $role_id)
    {
        ...
        return view('dashboard.roles.permissions.show', compact(['role','permissionGroup','rolePermissionsArray']));
    }
