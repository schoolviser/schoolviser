<div class="offcanvas offcanvas-end rounded-start" style="width: 35%;" data-bs-scroll="true" tabindex="-1" id="searchStudentsOffcanvas" aria-labelledby="searchStudentLabel">
    ...
    <div class="offcanvas-header flex-column align-items-start w-100">
        ...
        <div class="d-flex w-100">
            <input 
                ...
                data-url="{{ route('tertiary.students.search') }}"
                data-profile-url={{ route('tertiary.students.show', 'replace') }}
            />
