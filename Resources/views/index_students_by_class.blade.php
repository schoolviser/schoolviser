...
@section('pageheader', $clazz->name.' Students')
    ...
    <div class="card">
      <div class="card-body p-1 row">
        ...
        <div class="col-lg-6 pt-2">
          <div class="dropdown">
            <a id="my-dropdown" class="dropdown-bs-toggle text-small text-muted cursor-pointer font-weight-bold text-primary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">View By Class</a>
    ...
    <div class="card">
      <div class="card-body m-1">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-bordered table-striped" id="studentsByClassTablex">
            <thead>
              <tr>
                <th>Reg No</th>
                <th>Name</th>
