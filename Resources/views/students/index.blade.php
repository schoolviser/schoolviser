        ...
        <table class="table table-hover align-middle table-row-dashed fs-6 gy-5" id="studentsTables">
          ...
          <tbody>
              @foreach ($students as $student)
                <tr class="">
                  <td><a href="{{ route('students.profile', ['id' => $student->id]) }}" style="text-decoration: none;"><small class="font-12 bg-light ">{{ $student->regno ?? $student->access_number }}</small></a></td>
                  <td>
                    <a href="{{ route('students.profile', ['id' => $student->id]) }}" style="text-decoration: none;" class="pl-5"><span class="font-14 bg-light py-1 px-3 rounded-4 fw- text-dark">{{ $student->first_name." ".$student->last_name }}</span></a>
                  </td>
                  ...
                  <td class="text-center">
                    <a href="{{ route('students.edit', ['id' => $student->id]) }}" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
