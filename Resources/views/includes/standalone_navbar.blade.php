   ...
   <div class="container">
     <ul class="nav page-navigation">
      <li class="nav-item">
       ...
       @if (role_has_permission(auth()->user()->role_id, $studentsPermissions::CAN_MANAGE_STUDENTS_INFO))
       <li class="nav-item">
         ...
         <div class="submenu">
           <ul class="submenu-item">
            ...
            @include('dashboard.includes.navitems.registration_navitems')
           </ul>
         </div>
       </li>
       @endif
      ...
      <!-- Fees Management -->
      @inject('feesPermissions', '\App\FeesPermissionRegistrar')

      @if (role_has_permission(auth()->user()->role_id, $feesPermissions::CAN_MANAGE_FEES))
      <li class="nav-item">
        <a class="nav-link">
          <i class="mdi mdi-wallet menu-icon"></i>
          <span class="menu-title">Tuition Collection</span>
          <i class="menu-arrow"></i>
        </a>
        <div class="submenu" id="fees">
          <ul class="nav flex-column sub-menu">
            @include('dashboard.includes.navitems.fees_navitems', ['feesPermissions' => $feesPermissions])
          </ul>
        </div>
      </li>
      @endif
       ...
       @if (in_array(config('schoolviser.modules', []), 'accounting'))
           @include('accounting::includes.nav_items')
       @endif
     ...
     @endif
      ...
      @inject('libraryPermissions', '\App\LibraryPermissionRegistrar')

      @if (role_has_permission(auth()->user()->role_id, $libraryPermissions::CAN_MANAGE_LIBRARY))
      <li class="nav-item d-none">
        <a href="#" class="nav-link">
          <i class="mdi mdi-book-open menu-icon"></i>
        ...
        <div class="submenu">
          <ul class="submenu-item">
            @include('dashboard.includes.navitems.library_navitems', ['libraryPermissions' => $libraryPermissions])
          </ul>
        </div>
      </li>
      @endif
...
@include('dashboard.includes.offcanvas.user')
