<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    ...
    <button class="navbar-toggler navbar-toggler-left align-self-center" id="sidebarLeftToggler" data-bs-toggle="minimize">
    ...
    <ul class="navbar-nav w-25">
      <h6 class="" style="font-weight: 900;">{{ option('school_name') }}</h6>
    </ul>
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item nav-logout d-none d-md-block mr-3">
        <a class="nav-link" href="#"><small>{{ option('current_accounting_period_name') }}</small></a>
      </li>
      ...
      <li class="nav-item nav-profile dropdown d-none d-md-block">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="nav-profile-text">Analytics </div>
        </a>
      ...
      <li class="nav-item nav-profile dropdown d-none d-md-block">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="nav-profile-text text-capitalize">{{ auth()->user()->name }} </div>
        </a>
        <div class="dropdown-menu center navbar-dropdown" aria-labelledby="profileDropdown">
          <a class="dropdown-item" href="{{ route('account.settings') }}">
            <i class="flag-icon flag-icon-bl mr-3"></i> Settings </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">
            <i class="flag-icon flag-icon-cn mr-3"></i> Logout </a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
