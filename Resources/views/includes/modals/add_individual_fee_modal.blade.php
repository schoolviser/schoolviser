<!-- AddIndividualFeeModal -->

<div  class="modal fade" id="{{'addIndividualFeeModal'.$registration->id}}" tabindex="-1" data-bs-backdrop="static" -bs-keyboard="false"  role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
 <div class="modal-dialog modal-dialog-scrollable  modal-sm" role="document">
   <form class="modal-content" action="{{ route('fees.individualfee.store', ['termly_registration_id' => $registration->id]) }}" method="POST">
     ...
     <div class="modal-header">
       <h5 class="modal-title font-16" id="{{ 'modalTitleId'.$registration->id }}">
         Add Fine Fee
       </h5>
       <button
         type="button"
     ...
     <div class="modal-body row">
       ...
       @inject('individualFeeCategories', 'App\Models\Fee\IndividualFeeCategory')
       @php
           $individualFees = $individualFeeCategories::others()->get();
       @endphp
       <div class="col-lg-12 mt-3">
         <select name="category" id="" class="form-control">
           <option value="">Select Category</option>
           @foreach ($individualFees as $fee)
