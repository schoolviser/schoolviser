...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/schoolviser.basic.css') }}">
    ...
    <script src="{{ asset('js/schoolviser.basic.js') }}" defer></script>
...
<body style="background-coloor: rgb(241,250,248)">
    ...
    @include('schoolviser::includes.topbar')
        ...
        <div id="content" class="p-4">
            <div class="row mb-4">
                ...
                <div class="d-none d-md-block mb-3 col-md-8 col-lg-6 text-lg-end  module-links module-quick-links module-nav">
                    @yield('module-page-actions', 'provide module page links using module-page-links')
                </div>
                ...
                <div class="d-block d-md-none col-3 text-lg-end  mobile-module-links">
                    <div class="dropdown pt-3 pb-1 p-lg-0 m-lg-0">
                        ...
                        <div class="dropdown-menu" aria-labelledby="triggerId">
                            @yield('mobile-module-page-actions')
    ...
    @include('schoolviser::includes.offcanvas.user')
    @includeIf('schoolviser::includes.offcanvas.sidebar_small', ['some' => 'data'])
