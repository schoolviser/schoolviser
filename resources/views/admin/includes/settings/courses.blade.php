<div class="card mb-3">
    ...
    <div class="card-body">
      <ul class="list-unstyled">
        @usertype('master')<li><a href="{{route('site.settings.courses')}}" class=" link rounded-1">Courses</a></li>@endusertype
        @usertype('master')<li><a href="{{route('site.settings.course.groups')}}" class=" link rounded-1">Course Groups</a></li>@endusertype
